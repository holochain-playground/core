import { Hash, DHTOp, SysMetaVal, SignedHeaderHashed, ValidationReceipt } from '@holochain-open-dev/core-types';
...
export declare const register_header_on_basis: (basis: Hash, header: SignedHeaderHashed) => (state: CellState) => void;
