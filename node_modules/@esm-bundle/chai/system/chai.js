...
/*!
			 ...
			 * @return {Boolean} result
			 */
function(e,t,n,o){var r=n.length;if(0===r)return!0;for(var i=0;i<r;i+=1)if(!1===c(e[n[i]],t[n[i]],o))return!1;return!0}(e,t,o,n);var i=h(e),s=h(t);return i.length&&i.length===s.length?(i.sort(),s.sort(),l(i,s,n)):0===o.length&&0===i.length&&0===r.length&&0===s.length}
/*!
